...
import {burnInstructionData} from "./burn";
import {transferInstructionData} from "./transfer";
...
export function decodeTransferCheckedInstructionUnchecked({
    ...
    let d = transferCheckedInstructionData.decode(data);
    let fd = {instruction: d.instruction, amount: d.amount, decimals: d.decimals};
