...
import { bool, publicKey, u64 } from 'libs/buffer-layout-utils';
...
export const MintLayout = struct<RawMint>([ //TODO got rid of the generic here, let's see if it breaks something...
