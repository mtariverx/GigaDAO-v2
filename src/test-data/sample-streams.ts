...
let sampleTokenStream1: SubscribedTokenStream = {
    ...
    token_ticker: "BTPS",
    // token_image_url: "https://gateway.pinata.cloud/ipfs/Qmf5gyuFsYg7gsHgaXxTebkMGCMKen7tz4Y6pqKLyfFycK?preview=1",
...
let sampleTokenStream2: SubscribedTokenStream = {
    ...
    token_name: "Gigs",
    token_ticker: "GIGS",
    // token_image_url: "https://upload.wikimedia.org/wikipedia/commons/thumb/b/b2/Lightning_Bolt_on_Circle.svg/1200px-Lightning_Bolt_on_Circle.svg.png",
    // token_image_url: "/img/token-logos/giga_logo.png",
...
let sampleStreamArray = [sampleTokenStream1, sampleTokenStream2];
export {sampleStreamArray};
